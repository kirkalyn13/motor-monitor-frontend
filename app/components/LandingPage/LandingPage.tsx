  ...
  return (
    <section 
      ...
      <div className="flex flex-col md:flex-row my-8">
        <Link 
          className="px-16 py-4 mx-4 my-2 text-white text-center border border-0 rounded-md bg-amber-500 bg-opacity-50
        ...
        <Link 
          className="px-16 py-4 mx-4 my-2 text-white text-center border border-0 rounded-md bg-black bg-opacity-50
